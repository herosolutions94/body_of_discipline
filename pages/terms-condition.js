          ...
          <div className="contain">
            <div className="outer">
              <div className="content_center">
                <div className="title">OUR TERMS</div>
                <h2>Terms and conditions</h2>
              </div>
              <p>
                Welcome to BodyDiscipline! We are committed to protecting your privacy.
                This Privacy Policy explains how we collect, use, disclose, and
                safeguard your information when you visit our website
                 <Link className="link" href="/"> BodyDiscipline.com</Link>, use our platform, or engage with our
